...
namespace Shoplinhkien.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public AdminPagesController(ShoplinkkienContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumb,Published,Title,MetaDesc,MetaKey,Alias,CreatedAt,Ordering,Creator")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PageId,PageName,Contents,Thumb,Published,Title,MetaDesc,MetaKey,Alias,CreatedAt,Ordering,Creator")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            if (id != page.PageId)
            {
                return NotFound();
