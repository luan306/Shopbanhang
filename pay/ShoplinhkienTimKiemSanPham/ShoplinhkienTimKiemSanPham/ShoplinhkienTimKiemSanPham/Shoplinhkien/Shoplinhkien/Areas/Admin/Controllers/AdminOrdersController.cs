...
namespace Shoplinhkien.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public AdminOrdersController(ShoplinkkienContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note,Total,PaymentStatusId,ShipperId,Address,LocationId,District,Ward")] Order order)
        {
            if (ModelState.IsValid)
            {
                _context.Add(order);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note,Total,PaymentStatusId,ShipperId,Address,LocationId,District,Ward")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
