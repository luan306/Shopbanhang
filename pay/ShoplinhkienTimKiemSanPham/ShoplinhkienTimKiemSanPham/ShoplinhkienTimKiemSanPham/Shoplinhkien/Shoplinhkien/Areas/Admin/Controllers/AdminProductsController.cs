...
namespace Shoplinhkien.Areas.Admin.Controllers
{
    ...
    public class AdminProductsController : Controller
    {
        ...
        public AdminProductsController(ShoplinkkienContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ShortDesc,Description,CatId,Price,Discount,Image,Video,DateCreated,DateModified,BestSellers,HomeFlag,Active,Tags,Title,Alias,MetaDesc,MetaKey,UnitslnStock")] Product product, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
            if (ModelState.IsValid)
            {
                ...
                if (fThumb != null)
                {
                    ...
                    product.Image = await Utilities.UploadFile(fThumb, @"products", image.ToLower());
                }
