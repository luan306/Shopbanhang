...
namespace Shoplinhkien.Areas.Admin.Controllers
{
    ...
    //    //{
    //    //    var shoplinkkienContext = _context.Customers.Include(c => c.Account).Include(c => c.Location);
    ...
    //    public async Task<IActionResult> Create([Bind("CustomerId,FullName,Birthday,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateDate,Password,Salt,LastLogin,Active,AccountId")] Customer customer)
    //    {
    ...
    //    [HttpPost]
    //    [ValidateAntiForgeryToken]
    //    public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FullName,Birthday,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateDate,Password,Salt,LastLogin,Active,AccountId")] Customer customer)
    //    {
